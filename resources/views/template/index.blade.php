...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <a href="/"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/Nintendo_red_logo.svg/2560px-Nintendo_red_logo.svg.png" width = "128px" height = "40px" alt=""></a>
            <div class="container">
                    ...
                    <div class="row align-items-stretch mb-5">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="invalid-feedback" data-sb-feedback="name:required">Um nome é requerido.</div>
                            </div>
                            <div class="form-group">
                                <!-- Email address input-->
                                <input class="form-control" id="email" type="email" placeholder="Seu Email *" data-sb-validations="required,email" />
                                <div class="invalid-feedback" data-sb-feedback="email:required">Um Eamil é requerido.</div>
                            ...
                            <div class="form-group mb-md-0">
                                ...
                                <div class="invalid-feedback" data-sb-feedback="phone:required">Um Telefone é requerido.</div>
                            </div>
                        </div>
                        <div class="col-md-6">
        ...
        <footer class="footer py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4 text-lg-start">Copyright &copy; Vitor Gomes Valim 2023</div>
